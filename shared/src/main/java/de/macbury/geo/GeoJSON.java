...
public class GeoJSON {
  ...
  /**
   * Parses the given String as GeoJSON and returns a concrete subclass of
   * {@link GeoJSON} corresponding to the type of the root object.
   * @param rawJson
   * @return
   */
  public static GeoJSON parse(String rawJson) {
    return JsonHelper.fromJson(rawJson, GeoJSON.class);
  }
